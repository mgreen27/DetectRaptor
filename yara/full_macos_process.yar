rule ELASTIC_Macos_Trojan_Eggshell_Ddacf7B9 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Eggshell.yar#L1-L23"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Creddump_Keychainaccess_535C1511 : FILE MEMORY {
    meta:
		...
		modified = "2024-08-19"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Creddump_KeychainAccess.yar#L1-L25"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Hacktool_Bifrost_39Bcbdf8 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Hacktool_Bifrost.yar#L1-L27"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Hacktool_Swiftbelt_Bc62Ede6 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Hacktool_Swiftbelt.yar#L1-L44"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Thiefquest_9130C0F3 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L1-L22"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Thiefquest_Fc2E1271 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L24-L42"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Thiefquest_86F9Ef0C : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L44-L62"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Thiefquest_40F9C1C3 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L64-L82"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Thiefquest_0F9Fe37C : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L84-L102"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "12fb0eca3903a3b39ecc3c2aa6c04fe5faa1f43a3d271154d14731d1eb196923"
...
rule ELASTIC_Macos_Trojan_Thiefquest_1F4Bac78 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Thiefquest.yar#L104-L122"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "12fb0eca3903a3b39ecc3c2aa6c04fe5faa1f43a3d271154d14731d1eb196923"
...
rule ELASTIC_Macos_Trojan_Electrorat_B4Dbfd1D : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Electrorat.yar#L1-L22"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Infostealer_Encodedosascript_Eeb54A7E : FILE MEMORY {
    meta:
		...
		modified = "2024-08-26"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/Macos_Infostealer_EncodedOsascript.yar#L1-L21"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Infostealer_Mdquerypassw_6125F987 : FILE MEMORY {
    meta:
		...
		modified = "2024-08-19"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Infostealer_MdQueryPassw.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Fplayer_1C1Fae37 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Fplayer.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Kandykorn_A7Bb6944 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_KandyKorn.yar#L1-L29"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Backdoor_Useragent_1A02Fc3A : FILE MEMORY {
    meta:
		...
		modified = "2022-07-22"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Backdoor_Useragent.yar#L1-L23"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Getshell_F339D74C : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Getshell.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Backdoor_Kagent_64Ca1865 : FILE MEMORY {
    meta:
		...
		modified = "2022-07-22"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Backdoor_Kagent.yar#L1-L25"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Virus_Pirrit_271B8Ed0 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Pirrit.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Virus_Vsearch_0Dd3Ec6F : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Vsearch.yar#L1-L18"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Virus_Vsearch_2A0419F8 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Vsearch.yar#L20-L37"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Backdoor_Applejeus_31872Ae2 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Backdoor_Applejeus.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_28B13E67 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_75C8Cb4E : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L21-L39"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_17B564B4 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L41-L59"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_C90C088A : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L61-L79"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_3965578D : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L81-L99"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_00D9D0E9 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L101-L119"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_650B8Ff4 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L121-L139"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_C8Ad7Edd : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L141-L159"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_Cb7344Eb : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L161-L179"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_753E5738 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L181-L199"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Bundlore_7B9F0C28 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Bundlore.yar#L201-L219"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Generic_A829D361 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Generic.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Infostealer_Mdquerytoken_1C52D574 : FILE MEMORY {
    meta:
		...
		modified = "2024-08-19"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Infostealer_MdQueryToken.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Amcleaner_445Bb666 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Amcleaner.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Amcleaner_A91D3907 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Amcleaner.yar#L21-L39"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Amcleaner_8Ce3Fea8 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Amcleaner.yar#L41-L59"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "c85bf71310882bc0c0cf9b74c9931fd19edad97600bc86ca51cf94ed85a78052"
...
rule ELASTIC_Macos_Virus_Maxofferdeal_53Df500F : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Maxofferdeal.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Virus_Maxofferdeal_F4681Eba : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Maxofferdeal.yar#L21-L39"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "ecd62ef880da057726ca55c6826ce4e1584ec6fc3afaabed7f66154fc39ffef8"
...
rule ELASTIC_Macos_Virus_Maxofferdeal_4091E373 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Maxofferdeal.yar#L41-L59"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Virus_Maxofferdeal_20A0091E : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Virus_Maxofferdeal.yar#L61-L79"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Adload_4995469F : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Adload.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Adload_9B9F86C7 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Adload.yar#L21-L39"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Adload_F6B18A0A : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Adload.yar#L41-L59"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Hacktool_Jokerspy_58A6B26D : FILE MEMORY {
    meta:
		...
		modified = "2023-06-19"
		reference = "https://www.elastic.co/security-labs/inital-research-of-jokerspy"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/Macos_Hacktool_JokerSpy.yar#L1-L25"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Infostealer_Mdquerysecret_5535Ab96 : FILE MEMORY {
    meta:
		...
		modified = "2024-08-19"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Infostealer_MdQuerySecret.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Infostealer_Mdquerytcc_142313Cb : FILE MEMORY {
    meta:
		...
		modified = "2024-08-19"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Infostealer_MdQueryTCC.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "d895075057e491b34b0f8c0392b44e43ade425d19eaaacea6ef8c5c9bd3487d8"
...
rule ELASTIC_Macos_Cryptominer_Generic_D3F68E29 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Cryptominer_Generic.yar#L1-L21"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Cryptominer_Generic_365Ecbb9 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Cryptominer_Generic.yar#L23-L41"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Cryptominer_Generic_4E7D4488 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Cryptominer_Generic.yar#L43-L61"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "e2562251058123f86c52437e82ea9ff32aae5f5227183638bc8aa2bc1b4fd9cf"
...
rule ELASTIC_Macos_Cryptominer_Xmrig_241780A1 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Cryptominer_Xmrig.yar#L1-L22"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Rustbucket_E64F7A92 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_RustBucket.yar#L1-L22"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Sugarloader_E7E1D99C : FILE MEMORY {
    meta:
		...
		modified = "2023-10-24"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_SugarLoader.yar#L1-L23"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Aobokeylogger_Bd960F34 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Aobokeylogger.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_6Cab0Ec0 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_293Bfea9 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L21-L42"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "7ab5490dca314b442181f9a603252ad7985b719c8aa35ddb4c3aa4b26dcc8a42"
...
rule ELASTIC_Macos_Trojan_Metasploit_448Fa81D : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L44-L64"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
		hash = "7ab5490dca314b442181f9a603252ad7985b719c8aa35ddb4c3aa4b26dcc8a42"
...
rule ELASTIC_Macos_Trojan_Metasploit_768Df39D : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L66-L85"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_7Ce0B709 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L87-L106"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_F11Ccdac : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L108-L127"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_D9B16F4C : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L129-L148"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_2992B917 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L150-L169"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_27D409F1 : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L171-L190"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_65A2394B : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L192-L211"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_C7B7A90B : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L213-L232"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_4Bd6Aaca : FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L234-L253"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Metasploit_5E5B685F : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Metasploit.yar#L255-L273"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Hloader_A3945Baf : FILE MEMORY {
    meta:
		...
		modified = "2023-10-23"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_HLoader.yar#L1-L21"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Genieo_5E0F8980 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Genieo.yar#L1-L19"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Genieo_37878473 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Genieo.yar#L21-L39"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Genieo_0D003634 : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Genieo.yar#L41-L59"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Trojan_Genieo_9E178C0B : FILE MEMORY {
    meta:
		...
		modified = "2021-10-25"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Trojan_Genieo.yar#L61-L79"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
...
rule ELASTIC_Macos_Backdoor_Fakeflashlxk_06Fd8071 : FILE MEMORY {
    meta:
		...
		modified = "2022-07-22"
		reference = "https://github.com/elastic/protections-artifacts/"
		source_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/yara/rules/MacOS_Backdoor_Fakeflashlxk.yar#L1-L21"
		license_url = "https://github.com/elastic/protections-artifacts//blob/195c9611ddb90db599d7ffc1a9b0e8c45688007d/LICENSE.txt"
